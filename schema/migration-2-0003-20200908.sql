...
BEGIN
  ...
  IF next_version = 3 THEN
    ...
    EXECUTE 'CREATe TABLE "treasury"("id" SERIAL8  PRIMARY KEY UNIQUE,"addr_id" INT8 NOT NULL,"cert_index" INT4 NOT NULL,"amount" lovelace NOT NULL,"registered_tx_id" INT8 NOT NULL)' ;
    EXECUTE 'ALTER TABLE "treasury" ADD CONSTRAINT "unique_treasury" UNIQUE("addr_id","registered_tx_id")' ;
    EXECUTE 'ALTER TABLE "treasury" ADD CONSTRAINT "treasury_addr_id_fkey" FOREIGN KEY("addr_id") REFERENCES "stake_address"("id") ' ;
    EXECUTE 'ALTER TABLE "treasury" ADD CONSTRAINT "treasury_registered_tx_id_fkey" FOREIGN KEY("registered_tx_id") REFERENCES "tx"("id") ' ;
    EXECUTE 'ALTER TABLE "treasury" ADD CONSTRAINT "treasuryfktx" FOREIGN KEY("registered_tx_id") REFERENCES "tx"("id")ON DELETE CASCADE ON UPDATE CASCADE' ;
