...
BEGIN
  ...
  IF next_version = 3 THEN
    ...
    EXECUTE 'CREATe TABLE "pool_update"("id" SERIAL8  PRIMARY KEY UNIQUE,"hash_id" INT8 NOT NULL,"pledge" NUMERIC(20,0) NOT NULL,"reward_addr_id" INT8 NOT NULL,"meta" INT8 NULL,"margin" DOUBLE PRECISION NOT NULL,"fixed_cost" NUMERIC(20,0) NOT NULL,"registered_tx_id" INT8 NOT NULL)' ;
    ...
    EXECUTE 'CREATe TABLE "pool_retire"("id" SERIAL8  PRIMARY KEY UNIQUE,"update_id" INT8 NOT NULL,"announced_tx_id" INT8 NOT NULL,"retiring_epoch" NUMERIC(20,0) NOT NULL)' ;
